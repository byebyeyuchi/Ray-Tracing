...
public class Parser {
	...
	public static Camera createCamera(Node dataNode) {
        ...
        Node focalAttr = dataNode.getAttributes().getNamedItem("focalLen");
        if ( focalAttr != null ) {
	...
	public static Material createMaterial(Node dataNode) {
		...
		if( refAttr  != null ) {
	    	...
	    	Node mirrorAttr = dataNode.getAttributes().getNamedItem("reflect");
	    	if ( mirrorAttr != null ) {
	...
	public static Render createRender(Node dataNode) {
		...
		Node reflectAttr = dataNode.getAttributes().getNamedItem("reflect");
		if ( reflectAttr != null ) {
			Scanner s = new Scanner( reflectAttr.getNodeValue());
			render.reflect = s.nextBoolean();
			s.close();
		}
